...
def non_decrease_subseqs(s):
    ...
    res = [[]]
    for element in s:
        res.extend([seq + [element] for seq in res if not seq or seq[-1] <= element])
...
def num_trees(n):
    ...
    *   *        *       *
    ...
    """
    # solve half of the problem first, ignoring the requirement of being full binary tree
    catalan_nums = [1]
    for i in range(1, n):
        res = 0
        for j in range(i):
            res += catalan_nums[j] * catalan_nums[i-j-1]
        catalan_nums.append(res)
...
class VendingMachine:
    ...
    def restock(self, amt):
        assert self.stock_amt >= 0
        self.stock_amt += amt
        return f'Current {self.product} stock: {self.stock_amt}'
    ...
    def add_funds(self, amt):
        if self.stock_amt:
            ...
            return f'Nothing left to vend. Please restock. Here is your ${amt}.'
