...
def double_eights(n):
    ...
    True
    """
    def helper(num, found_one=False):
        if found_one and num % 10 == 8:
            return True
        if num == 0:
            return False
        return helper(num//10, num%10==8)
...
def coords(fn, seq, lower, upper):
    ...
    [[-2, 4], [1, 1], [3, 9]]
    """
    return list(filter(lambda x: x, [[i, i**2] if upper >= i**2 >= lower else None for i in seq]))
